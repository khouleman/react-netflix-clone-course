                    ...
                    <div>
                        {
                            mediaType !== 'movie'
                                ?
                                <FormControl fullWidth className={"select__season"}>
